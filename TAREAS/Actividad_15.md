...
Bloque if _name_ == "_main_":: Este bloque asegura que el código dentro de él solo se ejecute cuando el script se ejecute directamente, no cuando se importe como un módulo en otro script. Define el nombre de dominio como 'example.com' y llama a la función dns_lookup() con este nombre de dominio.
